    ...
    return (
        <div className='font-roboto'>
            ...
            <div className='mt-2 gap-4 flex justify-between'>
                <div className=' bg-white h-56 w-4/12 rounded-xl flex gap-4'>
                ...
                <div className=' bg-white w-8/12 rounded-xl px-4 py-5'>
                    ...
                    <form action="" method="post">
                        ...
                        <div className='h-16 border-t px-4 mt-3 flex items-center justify-end'>
                            <button className='w-2/12 bg-orange-500 rounded-md text-white cursor-pointer hover:bg-orange-700 text-sm h-9'>Save Details</button>
                        </div>
                    </form>
