    ...
    return (
        <div className='font-roboto px-4'>
            <div className='mt-16 py-3 text-center'>
                <h1 className='lg:text-2xl text-xl tracking-wider font-semibold'>Ready to Get Started?</h1>
                <p className='leading-loose py-2 text-gray-600'>Choose a plan that suits your business needs</p>
                <label class="inline-flex items-center me-5 cursor-pointer">
                    <span class="ms-3 tracking-wider px-4 text-gray-900 font-semibold sm:text-lg text-sm dark:text-gray-300">Monthly</span>
                    ...
                    <span class="tracking-wider px-4 text-gray-900 font-semibold sm:text-lg text-sm dark:text-gray-300">Yearly</span>
                </label>
                <div className='flex items-center lg:w-2/12 sm:w-4/12 w-10/12 m-auto '>
                ...
                <div className='grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-3'>
                    <div className='bg-white py-5 lg:px-7 px-4 rounded-xl shadow-lg'>
                        <div className='text-start'>
                            <div className='flex mt-8 items-center justify-between'>
                                <h1 className='lg:text-2xl text-xl font-semibold'> <span className='text-orange-500'><FontAwesomeIcon icon={faGift} /></span> Free</h1>
                            </div>
                            ...
                            <div className='mt-3 space-y-4'>
                                ...
                                <br />
                                <button className="w-full p-4  rounded-full bg-orange-500 text-white text-sm hover:bg-orange-700">Get Your Free Plan</button>
                            </div>
                        </div>
                    </div>
                    <div className='bg-white py-5 lg:px-7 px-4 rounded-xl shadow-lg'>
                        <div className='text-start'>
                            <div className='flex mt-8 items-center justify-between'>
                                <h1 className='lg:text-2xl text-xl font-semibold'> <span className='text-orange-500'><FontAwesomeIcon icon={faFire} /></span> Pro</h1>
                            ...
                            <div className='mt-3 space-y-4'>
                                ...
                                <br />
                                <button className="w-full p-4  rounded-full bg-orange-500 text-white text-sm hover:bg-orange-700">Get Started</button>
                            </div>
                        </div>
                    </div>
                    <div className='bg-white py-5 lg:px-7 px-4 rounded-xl shadow-lg'>
                        <div className='text-start'>
                            <div className='flex mt-8  items-center justify-between'>
                                <h1 className='lg:text-2xl text-xl font-semibold'> <span className='text-orange-500'><FontAwesomeIcon icon={faCrown} /></span> Ultimate</h1>
                            </div>
                            ...
                            <div className='mt-3 space-y-4'>
                                ...
                                <br />
                                <button className="w-full p-4 text-sm  rounded-full bg-orange-500 text-white hover:bg-orange-700">Get Started</button>
                            </div>
                        </div>
                    </div>
                </div>
